...
public class User implements Serializable {
	...
	private Map<String,UserDoc> userDocWeightMap;
	...
	public User()
	{
		...
		userDocWeightMap= new HashMap<String, UserDoc>();
	}
	...
	public Map<String, UserDoc> getUserDocWeightMap() {
		return userDocWeightMap;
	}
	public void setUserDocWeightMap(Map<String, UserDoc> userDocWeightMap) {
