package DBUtils.AppContextListener;
...
//Servlet will be called on server startup and will check if DB connection is established and log4J is configured or not.
@WebListener
public class AppContextListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent servletContextEvent) {
		...
		try {
			DBUtils connectionManager = new DBUtils(dbURL, user, pwd);
